...
function Query_1() {
  ...
  React.useEffect(() => {
    Axios.get('http://localhost:3001/normalizedbudgetoverpopularity/yearly').then((response) => {
  ...
  function generateData() {
    ...
    for (let i = 0; i < query3Data.length; i++) {
      ...
      let value = query3Data.at(i)["BUDGETOVERPOPULARITY"];
        ...
        <div class="container">
          <div class="row align-items-start my-5">
            <div class="col-lg-6">                        
              ...
              <h3 style={{marginLeft: 100, marginBottom: 30}}> vs. Time</h3>     
            ...
            <div class="col-lg-6">
              <h1 class="font-weight-light">BUDGET OF FILMS WITH THEIR POPULARITY</h1>
              <dl>
